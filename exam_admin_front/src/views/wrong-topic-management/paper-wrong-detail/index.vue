<template>
  <div class="container">
    <Breadcrumb
      :items="[
        'menu.wrongManage.paperWrongAnalyse',
        'menu.wrongManage.paperWrongAnalyse.detail',
      ]"
    />
    <WrongDetail
...
<script lang="ts" setup>
  ...
  import { getPaperAnalyse } from '@/api/exam';
  ...
  const reloadDetail = async () => {
    loading.value = true;
    await getPaperAnalyse(paperId.value as string).then((res: any) => {
