export default {
  ...
  'userSetting.label.roles': '角色',
  'userSetting.label.deptCode': '部门',
  ...
  'userSetting.basicInfo.form.label.phone': '手机',
  'userSetting.basicInfo.placeholder.phone': '请输入您的手机号',
  'userSetting.basicInfo.placeholder.countryRegion': '请选择',
  'userSetting.basicInfo.form.label.sex': '性别',
  'userSetting.basicInfo.placeholder.sex': '请选择',
